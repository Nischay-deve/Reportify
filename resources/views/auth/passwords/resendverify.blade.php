...
<head>
    ...
    <title>TDTY - Resend Verify Email</title>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center bg-white">
                    <h4>Resend Verify Email</h4>
                    <p>Enter your email address, and we'll send you a link to verify your email.</p>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('resend.verify.email', ['slug' => $slug]) }}">
                        @csrf
                        ...
                        <p style="text-align: center;">                                                    
                            <button type="submit" class="btn btn-primary w-30 login-button" style="margin: auto">Resend Link to Verify Email</button>
                        </p>
                    </form>
