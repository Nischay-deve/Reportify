                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled text-center text-muted mb-0 mt-2">
                            <li class="list-inline-item font-size-13"><i class="mdi mdi-album font-size-16 align-middle text-{{config('app.color_scheme')}} me-2"></i>Total Budget</li>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <p class="font-size-13 text-muted">
                                There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, or randomised words which don't look even slightly believable. If you are going to use a
                                passage.
                            </p>
                        ...
                        <div class="row">
                            <div class="col-sm-6 align-self-center">
                                <div class="live-tile text-center" data-mode="carousel" data-direction="vertical" data-delay="3500" data-height="10">
                                    <div class="mt-2">
                                        <h5 class="text-{{config('app.color_scheme')}} pt-2">P1-Launch Date</h5>
                                        <small class="text-muted">Tuesday, 25 December 2018</small>
                                        <h3 class="text-dark mt-1">170 Days</h3>
                                    </div>
                                    <div class="mt-2">
                                        <h5 class="text-{{config('app.color_scheme')}} pt-2">P2-Launch Date</h5>
                                        <small class="text-muted">Tuesday, 25 December 2018</small>
                                        <h3 class="text-dark mt-1">180 Days</h3>
                                    </div>
                                    <div class="mt-2">
                                        <h5 class="text-{{config('app.color_scheme')}} pt-2">P3-Launch Date</h5>
                                        <small class="text-muted">Tuesday, 25 December 2018</small>
                            ...
                            <div class="col-sm-6">
                                <div class="text-center knob-Prosess mt-4 mt-sm-0" dir="ltr">
                                    ...
                                    <div class="text-center knob-prosess-btn">
                                        <a class="btn btn-sm btn-{{config('app.color_scheme')}} text-white px-3 mt-2 mb-0">Refresh</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-hover table-centered table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>20/3/2018</td>
                                                <td>5/5/2018</td>
                                                <td><span class="badge bg-{{config('app.color_scheme')}}">Active</span></td>
                                                <td>
                                                    <small class="float-end ms-2 font-size-12">92%</small>
                                                    <div class="progress mt-2" style="height: 5px;">
                                                        <div class="progress-bar bg-{{config('app.color_scheme')}}" role="progressbar" style="width: 92%;" aria-valuenow="92" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="assets/images/users/user-3.jpg" alt="" class="avatar-xs rounded-circle me-2" />
                                                    Frank M. Lyons
                                                </td>
                                                <td>11/6/2018</td>
                                                <td>15/7/2018</td>
                                            ...
                                            <tr>
                                                <td>Website &amp; Blog</td>
                                                <td>
                                                    <img src="assets/images/users/user-4.jpg" alt="" class="avatar-xs rounded-circle me-2" />
                                                    Hyman M. Cross
                                                </td>
                                                <td>21/6/2018</td>
                                                <td>3/7/2018</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="assets/images/users/user-5.jpg" alt="" class="avatar-xs rounded-circle me-2" />
                                                    Angelo E. Butler
                                                </td>
                                                <td>30/4/2018</td>
                                                <td>1/6/2018</td>
                                                <td><span class="badge bg-{{config('app.color_scheme')}}">Active</span></td>
                                                <td>
                                                    <small class="float-end ms-2 font-size-12">78%</small>
                                                    <div class="progress mt-2" style="height: 5px;">
                                                        <div class="progress-bar bg-{{config('app.color_scheme')}}" role="progressbar" style="width: 78%;" aria-valuenow="78" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="assets/images/users/user-6.jpg" alt="" class="avatar-xs rounded-circle me-2" />
                                                    Robert C. Golding
                                                </td>
                                                <td>20/3/2018</td>
                                                <td>5/5/2018</td>
                                                <td><span class="badge bg-{{config('app.color_scheme')}}">Active</span></td>
                                                <td>
                                                    <small class="float-end ms-2 font-size-12">45%</small>
                                                    <div class="progress mt-2" style="height: 5px;">
                                                        <div class="progress-bar bg-{{config('app.color_scheme')}}" role="progressbar" style="width: 45%;" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Product Devlopment</td>
                                                <td>
                                                    <img src="assets/images/users/user-7.jpg" alt="" class="avatar-xs rounded-circle me-2" />
                                                    Kevin J. Heal
                                                </td>
                                                <td>14/2/2018</td>
                                                <td>10/8/2018</td>
                                                <td><span class="badge bg-{{config('app.color_scheme')}}">Active</span></td>
                                                <td>
                                                    <small class="float-end ms-2 font-size-12">35%</small>
                                                    <div class="progress mt-2" style="height: 5px;">
                                                        <div class="progress-bar bg-{{config('app.color_scheme')}}" role="progressbar" style="width: 35%;" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Website &amp; Blog</td>
                                                <td>
                                                    <img src="assets/images/users/user-8.jpg" alt="" class="avatar-xs rounded-circle me-2" />
                                                    Phillip T. Morse
                                                </td>
                                                <td>8/4/2018</td>
                                                <td>2/6/2018</td>
                                                <td><span class="badge bg-danger">Complete</span></td>
                                                <td>
                                                    <small class="float-end ms-2 font-size-12">100%</small>
                                                    <div class="progress mt-2" style="height: 5px;">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div data-simplebar style="max-height: 425px;">
                            <div class="activity">
                                <i class="mdi mdi-check text-{{config('app.color_scheme')}}"></i>
                                <div class="time-item">
                                    <div class="item-info">
                        ...
                        <div class="text-center mt-3">
                            <a href="#" class="btn btn-{{config('app.color_scheme')}}">View more</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div data-simplebar style="max-height: 260px;">
                            <div class="todo-list">
                                <div class="todo-box">
                                    <button type="button" class="btn link-{{config('app.color_scheme')}} remove">
                                        <i class="far fa-trash-alt"></i>
                                    </button>
                                    <div class="todo-task">
                                        <label class="ckbox"> <input type="checkbox" /><span>Icon change in Redesign App</span> </label>
                                    </div>
                                </div>
                                <div class="todo-box">
                                    <button type="button" class="btn link-{{config('app.color_scheme')}} remove">
                                    ...
                                    <div class="todo-task">
                                        <label class="ckbox"> <input type="checkbox" checked="" /><span>Add search button Market Research</span> </label>
                                    </div>
                                </div>
                                <div class="todo-box">
                                    <button type="button" class="btn link-{{config('app.color_scheme')}} remove">
                                    ...
                                    <div class="todo-task">
                                        <label class="ckbox"> <input type="checkbox" /><span>Test new features in tablets</span> </label>
                                    </div>
                                </div>
                                <div class="todo-box">
                                    <button type="button" class="btn link-{{config('app.color_scheme')}} remove">
                                    ...
                                    <div class="todo-task">
                                        <label class="ckbox"> <input type="checkbox" checked="" /><span>Send IOS App documents</span> </label>
                                    </div>
                                </div>
                                <div class="todo-box">
                                    <button type="button" class="btn link-{{config('app.color_scheme')}} remove">
                                    ...
                                    <div class="todo-task">
                                        <label class="ckbox"> <input type="checkbox" /><span>Connect API to pages</span> </label>
                                    </div>
                                </div>
                                <div class="todo-box">
                                    <button type="button" class="btn link-{{config('app.color_scheme')}} remove">
                        ...
                        <div class="input-group custom-input">
                            ...
                            <button class="btn btn-{{config('app.color_scheme')}} add-new-todo-btn">Add</button>
                        </div>
                    </div>
                </div>
                <!-- end card -->
