        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Admin User <i>({{$profile->name}})</i> Activity Log</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Team</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Admin Users <i>({{$profile->name}})</i> Activity Log</a></li>
                                            ...
                                            <tbody>
                                                ...
                                                @endphp                                                                                                  
                                                    <tr class="odd">
                                                        ...
                                                        <td>{{ $log->category ?? '' }}</td>
                                                        {{-- <td>{{ $log->target_user_name ?? '' }} <br>{{ $log->target_user_email ?? '' }}</td> --}}
                                                        <td>{{ $log->activity ?? '' }}</td>
