            ...
            <div class="col-md-12 col-xl-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <form id="add-user" action="{{ route('admin.users.updatepassword',[$user->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row gx-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 ">
                                        <label for="title" class="form-label pt-0"></label>
                                        <input type="submit" class="form-control btn btn-{{config('app.color_scheme')}} w-lg" name="submit" value="Update" style="margin-top: 7px;">
                                    </div>
                                </div>   
                            </div>
