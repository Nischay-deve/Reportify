            ...
            <div class="col-md-12 col-xl-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <form id="add-user" action="{{ route('admin.users.update', [$profile->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row gx-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 ">
                                        ...
                                        <select name="roles" class="form-control" id="roles" required="">
                                            ...
                                            <option value="{{$id}}" {{ old('roles',$id)== $selectedRole->role_id ? 'selected' : '' }}>{{$roles}}</option>
                                            @endforeach
                                        </select>
                                        @error('roles')
                                            <span class="invalid-feedback" role="alert">
...
{{-- Extra --}}
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 ">
                                        ...
                                        @php
                                            $placeExisting = $profile->profile->place_id;
                                        @endphp
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 ">
                                        ...
                                        <input type="text" id="occupation" name="occupation"
                                            ...
                                            value="{{ $profile->profile->occupation }}" placeholder="Enter occupation"
                                            required />
                                        @error('occupation')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 ">
                                        ...
                                        <textarea class="form-control @error('moreinfo') is-invalid @enderror" name="moreinfo" id="moreinfo"
                                            placeholder="Enter moreinfo" rows="3" required>{{ $profile->profile->moreinfo }}</textarea>
                                        @error('moreinfo')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 ">
                                        ...
                                        value="{{ $profile->profile->reference }}" placeholder="Enter name of Person who referred you here" />                                                
                                        @error('reference')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 ">
                                        ...
                                        value="{{ $profile->profile->reference_mobile }}" placeholder="Enter mobile of Person who referred you here" />                                                
