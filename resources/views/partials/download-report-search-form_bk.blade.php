                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div role="group" aria-label="Basic radio toggle button group">
                                            @foreach ($team as $key => $teams)
                                                <input value="{{ $teams->id }}" type="radio"
                                                    class="btn-check team_name" name="team_name"
                                                    id="btnradio{{ $teams->id }}" autocomplete="off">
                                                <label class="btn btn-outline-primary"
                                                    for="btnradio{{ $teams->id }}">{{ $teams->name }}
                                                    <br>({{ $teams->total_reports }} Reports)</label>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8" id="cat_subcat_container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 column-5 border-light" id="cat_container">
                                        <label for="module" class="form-label categoryHeading">Category</label>
                                    ...
                                    <div class="col-md-6 column-5 border-light" id="sub_cat_container">
                                        <label for="chapter_id" class="form-label categoryHeading">Sub-Category</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" id="location_container">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="location_id[]" id="location_id" multiple
                                    ...
                                    <div class="col-md-12" style="display:none;" id="location_state_container">
                                        <div class="mb-3">
                                            ...
                                            @endphp
                                            <select class="form-select" name="location_state_id[]" id="location_state_id"
                                    ...
                                    <div class="card text-dark bg-light mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="heading" class="form-label">Replace Report Heading
                                                            With</label>
                                                        <input type="text" class="form-control"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="heading" class="form-label">Add new Description to
                                                            file</label>
                                ...
                                <div class="collapse" id="advancedSearchContainer">
                                    ...
                                    <div class="card text-dark bg-light mb-3">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" value="asc" type="radio"
                                                                name="news_order_by_order" id="news_order_by_order_asc">
                                                            <label class="form-check-label" for="news_order_by_order">
                                                                Oldest NEWS on Top
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" value="desc" type="radio"
                                                                name="news_order_by_order" id="news_order_by_order_desc"
                                                                checked>
                                                            <label class="form-check-label" for="news_order_by_order">
                                                                Latest NEWS on Top
                                                            </label>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" value="all" type="radio"
                                                                name="report_from" id="report_from_all">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <p class="fs-6 fw-bold ">Download Report For <br><span class="label"
                                                            id="total_reports"></span> </p>
                                                    <div class="mb-3">


                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" value="daily_report"
                                                                id="daily_report" type="radio" name="report_data_type"
                                                                checked>
                                            ...
                                            <div class="row mb-3 custom_report_options" id="custom_report_options"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input value="custom_report_front_page_screenshots" type="checkbox"
                                                        name="custom_report_front_page_screenshots" class="btn-check"
                                                        id="custom_report_front_page_screenshots" autocomplete="off">
                                                    <label style="margin-right:2px;margin-bottom:5px;"
                                                        class="btn btn-outline-{{ config('app.color_scheme') }}"
                                                        for="custom_report_front_page_screenshots">Front page screenshot of
                                                        News
                                                        link</label>
                                                    ...
                                                    <input value="custom_report_fir" type="checkbox"
                                                        name="custom_report_fir" class="btn-check" id="custom_report_fir"
                                                        autocomplete="off">
                                                    <label style="margin-right:2px;margin-bottom:5px;"
                                                        class="btn btn-outline-{{ config('app.color_scheme') }}"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input  mb-2 mr-3 fs-5"
                                                                    value="1" id="group_by_location" type="checkbox"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="margin-top: 26px;">
                                        <a class="btn btn-secondary" href=" {{ route('report.pdf', $website_slug) }}">
                                            <i class="mdi mdi-eraser"></i> Clear Filters
                                        </a>
                                    </div>
                                </div>
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $.each(result.date_reports, function(key, value) {
                                $("#from_date_reports").html('(' + value
                                    .total_reports + ' Reports)');
                                $("#to_date_reports").html('(' + value
                                    .total_reports + ' Reports)');
                            });
            ...
            if (idTeam) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        var container = $('#category-btn-group');
                        var inputs = container.find('input');                       
                        $.each(result.modules, function(key, value) {
                            var id = key+1;                    
                            $('<input />', { type: 'checkbox', class: 'btn-check category_checkbox', id: 'cb'+id, name: 'module[]', value: value.id }).appendTo(container);
                            $('<label />', { 'for': 'cb'+id, class:'btn btn-outline-primary cat_checkbox', text: value.name + '\n' + '( ' + value.total_reports + ' Reports )' }).appendTo(container);                            
                            // $('<br /><br />').appendTo(container);
                        });
                        
                        $("#cat_subcat_container").show();
                        $("#cat_container").show();
            ...
            if (idModules) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $.each(result.chapters, function(key, value) {
                            var id = key+1;                    
                            $('<input />', { type: 'checkbox', class: 'btn-check sub_category_checkbox', id: 'scb'+id, name: 'chapter_id[]', value: value.id }).appendTo(container);
                            $('<label />', { 'for': 'scb'+id, class:'btn btn-outline-primary cat_checkbox', text: value.name + '\n' + '( ' + value.total_reports + ' Reports )' }).appendTo(container);                            
                            // $('<br /><br />').appendTo(container);
                        });
