...
<head>
    ...
    <script src="{{ asset('js/pages/lazysizes.min.js') }}"></script>
...
<body data-topbar="dark">
    ...
    @if(!empty($mode))        
        ...
        @elseif($mode == "view-all")
            @if($currentIssue == "rising-bharat")
                @include('partials.header')
            @endif    
        @endif
    @else
    ...
    <script>
        ...
        function calendar_dateChanged() {
            if ($('#calendar_date').is(":checked")) {
                $('#calendar_date_description').prop('required', true);
                $("#calendar_date_description_container").show();
            } else {
                $('#calendar_date_description').prop('required', false);
                $("#calendar_date_description_container").hide();
            }
        }

        function first_timeChanged() {
            if ($('#first_time').is(":checked")) {
                $('#first_time_description').prop('required', true);
                $("#first_time_description_container").show();
            } else {
                $('#first_time_description').prop('required', false);
                $("#first_time_description_container").hide();
            }
        }
    </script>
