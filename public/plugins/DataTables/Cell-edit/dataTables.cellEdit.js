...
jQuery.fn.dataTable.Api.register('MakeCellsEditable()', function (settings) {
    ...
    jQuery.fn.extend({
        ...
        updateEditableCell: function (callingElement) {
            ...
            //Note:  callingElement is the confirm or cancel button
            ...
            var columnName = $(callingElement).parents('td').data("column");
            // console.log('columnName', columnName);

            var identifierCell = $(callingElement).parents('tr').find("td:eq("+settings.identifier_column+")");
            ...
            function _update(newValue) {
                ...
                cell.data(newValue);
                //Return cell & row.
                settings.onUpdate(cell, row, oldValue, identifierCell, columnName);
            }
            // Get current page
