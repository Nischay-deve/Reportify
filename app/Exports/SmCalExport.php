...
class SmCalExport implements FromView, WithTitle,  WithStyles
{
    ...
    public function __construct($smcalendars, $listType, $dataCalendar, $calDates)
    {
       $this->smcalendars = $smcalendars;
    ...
    {
        return view('member.smcalendars.excel_export', [
            'smcalendars' => $this->smcalendars,
